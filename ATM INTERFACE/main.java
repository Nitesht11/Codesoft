...
class BankAccount {
    ...
    public void withdraw(int amount) {
        if (amount > 0 && amount <= balance) {
            balance -= amount; // Correctly deduct the amount from balance
        ...
        do {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Thanks for working with Nitesh Bank");
                    break;
                default:
...
public class main { // Class name changed to Main
    ...
    public static void main(String[] args) {
        ...
        if (pin.equals("4546")) { // String comparison fixed
            atm.run();
        } else {
